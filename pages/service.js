...
const service = () => {
    ...
    <div>
        ...
        <Stack direction="row" h="80px">
            <Text fontSize="50px" fontWeight="bold" mr="20px">Manager</Text>
        ...
        <br/>
        <Stack direction="row" h="80px">
            <Text fontSize="50px" fontWeight="bold" mr="20px">Front</Text>
            <Divider orientation="vertical" />
            <Text fontSize="20px"><br/>(각 부서별 역할 적는 곳)</Text>
        </Stack>
        ...
        <br/>
        <Stack direction="row" h="80px">
            <Text fontSize="50px" fontWeight="bold" mr="20px">Backend</Text>
            <Divider orientation="vertical" />
            <Text fontSize="20px"><br/>(각 부서별 역할 적는 곳)</Text>
        </Stack>
        ...
        <br/>
        <Stack direction="row" h="80px">
            <Text fontSize="50px" fontWeight="bold" mr="20px">DB</Text>
            <Divider orientation="vertical" />
            <Text fontSize="20px"><br/>(각 부서별 역할 적는 곳)</Text>
        </Stack>
        ...
        <br/>
        <Stack direction="row" h="80px">
            <Text fontSize="50px" fontWeight="bold" mr="20px">Server</Text>
            <Divider orientation="vertical" />
            <Text fontSize="20px"><br/>(각 부서별 역할 적는 곳)</Text>
        </Stack>
