import { Progress, CardFooter, CardBody, Image, CardHeader, Card, Box, Button, Container, Flex, Input, Select, Text, Heading, TableContainer, Table, Thead, Tr, Th, Tbody, Td, Tfoot, Stack } from "@chakra-ui/react";
    ...
    return (
        <Box>
            ...
            <Flex justify={"space-between"}>
                {/*공연 예약 현황 박스*/}
                <Box mr={1} w="61%" mt={5} fontSize="md" borderRadius={15} border="1px solid dodgerblue" p={4}>
                    <Flex>
                        <Image w="50%" h="auto" src='https://bit.ly/dan-abramov' alt='Dan Abramov' mr={5}></Image>
