    ...
    return (
        <Box>
            ...
            <Flex justify={"space-between"}>
                ...
                {/*예약자 검색 박스*/}
                <Box mr={1} w="45%" mt={5} fontSize="md" borderRadius={15} border="1px solid dodgerblue" p={4}>
                ...
                <Box mr={1} w="55%" mt={5} fontSize="md" borderRadius={15} border="1px solid dodgerblue" p={4}>
                    <Flex>
                        <Image w="50%" h="100%" src='https://bit.ly/dan-abramov' alt='Dan Abramov' mr={5}></Image>
